...
IMAGE2D_WO(textureBuffer,     rgba32f, 5);
...
void main() {
    ...
    imageStore(textureBuffer, calculateTextureCoord((gl_WorkGroupID.x * 4) + 2, maxTextureSize), vec4(normal0.xyz, uintBitsToFloat(lineC)));
